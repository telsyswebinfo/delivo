...
class _OtpVerificationScreenState extends State<OtpVerificationScreen> {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: MaterialButton(
                      ...
                      child: Text(
                        getTranslated(context, oTPVerification_button).toString(),
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                getTranslated(context, oTPVerification_receive_otp).toString(),
                              ...
                              GestureDetector(
                                ...
                                child: Text(
                                  getTranslated(context, oTPVerification_resend_again).toString(),
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              Text(
                                getTranslated(context, oTPVerification_text1).toString(),
                                style: TextStyle(color: Palette.loginHead, fontSize: 12),
                              ),
                              Text(
                                getTranslated(context, oTPVerification_text2).toString(),
                                style: TextStyle(color: Palette.loginHead, fontSize: 12),
                              ),
                            ],
                          ),
  ...
  Future<BaseModel<ResendOtpModel>> callApiResendOtp() async {
    ...
    try {
      ...
      setState(() {
        Fluttertoast.showToast(msg: 'SuccessFully Otp Send.', toastLength: Toast.LENGTH_SHORT, gravity: ToastGravity.BOTTOM);
      });
    } catch (error, stacktrace) {
      print("Exception occur: $error stackTrace: $stacktrace");
      return BaseModel()..setException(ServerError.withError(error: error));
